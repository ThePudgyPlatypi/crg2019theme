<!-- Styles in pricing-sizing stylesheet -->

<div class="pricing-container">
    <div class="pricing-head-content-container">
        <div class="pricing-heading">
            <h2 class="blue text-center shared-feature-h2 yellow-line yellow-line-center">Basic Print Pricing and Sizing</h2>
        </div>
        <div class="pricing-desc">
            <p class="text-center">Critical Response Group also offers many different size general prints to fit every application.</p>
        </div>
    </div>

    <div class="pricing-head-content-container align-center grid-padding-x">
    ...
    <div class="pricing-split-column">

        <div class="pricing-split-col-1">
            <?php get_image("sizing-chart", 'large') ?>
        </div>

        <div class="pricing-split-col-2">
